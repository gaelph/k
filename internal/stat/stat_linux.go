...
func (s PlatformStat) ATime() time.Time {
	return time.Unix(s.inner.Atim.Sec, s.inner.Atim.Nsec)
}

func (s PlatformStat) ModTime() time.Time {
	return time.Unix(s.inner.Mtim.Sec, s.inner.Mtim.Nsec)
}

func (s PlatformStat) CTime() time.Time {
	return time.Unix(s.inner.Ctim.Sec, s.inner.Ctim.Nsec)
}
